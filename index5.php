...
require INCLUDES_DIRECTORY.'/functions/category_listings.php';
...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
  ...
  <tr>
    ...
    <td valign="top"><table width="771" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="images/line1.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="5">
            <tr>
              <td><span class="style9"><strong>THURSDAY, AUGUST 20, 2007</strong> VOL. LXX, no. 33 NEW SERIES GLOUCESTER, VA. 23061 | MATHEWS, VA</span></td>
            </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <div class="category_area">
		  ...
		  echo $category_listings->categories_listings($categories_id);
		  } elseif (!empty($listings_id)) {
		  echo $category_listings->list_listings($listings_id);
		  } else {
		  echo $category_listings->top_news_listings();
		  }
		  ?>
		  </div>
	...
	<div class="category_content">
	  <table width="100%" border="0" cellspacing="0" cellpadding="8">
        <tr>
		  ...
		  <?PHP 
		  if (!empty($categories_id)) {
		  echo $category_listings->categories_previews($categories_id);
		  } elseif (!empty($listings_id)) {
		  echo $category_listings->listings_preview($listings_id);
		  } else {
		  echo $category_listings->top_news_listings_previews();
		  }
		  ?>
		  </td>
        </tr>
    ...
    <td align="left" valign="bottom">
	  <table width="228" height="240" border="0" cellpadding="15" cellspacing="0" class="notepad_area">
        <tr>
