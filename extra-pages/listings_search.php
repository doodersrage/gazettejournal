...
<title>Glouster-Mathews Gazette-Journal: Listing Search</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
  ...
  <tr>
    ...
    <td valign="top"><table width="771" border="0" cellspacing="0" cellpadding="0">
      ...
      <div class="category_area_contact">
<?PHP echo LISTING_SEARCH_TEXT; ?>
<form name="form1" id="form1" method="post" action="<?PHP echo SITE_ADDRESS; ?>listings_search_results.php">
  ...
  Both:
  <input name="searchtype" type="radio" value="both" checked="checked" />
  <br />
