...
$settings_qry = mysql_query("SELECT * FROM store_settings WHERE " . (!empty($edit) ? "store_settings_id = '".$edit."' AND " : "contenttype = 'email' AND") . " (hidden = '' OR hidden is null) ORDER BY name ASC;");
$item_id = 0;
...
<title>Admin Config: Email Settings</title>
...
<table width="800" border="0" align="center" cellpadding="3" class="main_table">
  <tr>
    ...
    <td valign="top">
	<div class="bc_nav"><?PHP echo brc(array('Email Content' => 'admin-config/emailsettings.php')); ?></div>
